...
def main():
    ...
    try:
        ...
        print("   • A2UI Protocol Server enables real-time UI updates")
        print("   • Press Ctrl+C to stop allp://localhost:8084")
        print(f"   💳 PayPal MCP Server:   {PAYPAL_MCP_SERVER_URL}")
        print(f"   📖 MCP Health Check:    {PAYPAL_MCP_SERVER_URL}/health")
        print("\n💡 USAGE:")
        print("   • Open http://localhost:8084 in your browser to access the main application")
        print("   • The PayPal MCP Server runs in the background to handle payments")
