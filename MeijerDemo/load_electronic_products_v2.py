# load_electronic_products_v2.py - Load electronic products into SAP_ELECTRONICS_PRODUCTS_2211_V2 table
...
def load_electronic_product_csv_data(cursor, csv_file_path):
    """Load electronic product data from CSV into SAP_ELECTRONICS_PRODUCTS_2211_V2 table"""
...
def main():
    ...
    csv_file = "data/electronicProduct.csv"
    
    print("="*80)
    print("🚀 Loading Electronic Products into SAP_ELECTRONICS_PRODUCTS_2211_V2")
    ...
    try:
        ...
        load_electronic_product_csv_data(cursor, csv_file)
        ...
        print(f"✅ Total electronic products in table: {count}")
